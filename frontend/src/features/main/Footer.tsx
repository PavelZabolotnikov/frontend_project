...
function Footer(): JSX.Element {
  ...
  return (
    <Container
      ...
      className={
        darkTheme
          ? 'container-footer dark-color-1'
          : 'container-footer ligth-color-1'
      }
    >
        ...
        <Container className="icons-con">
          <Link to="https://t.me/savorskaya" target="_blank">
            <svg
              ...
              className={
                darkTheme ? 'bi bi-instagram icon-dark' : 'bi bi-instagram icon'
              }
              viewBox="0 0 16 16"
            >
      ...
      <Container className="container-flex-colunm">
        {showForm ? (
          <FormForLawyer setShowForm={setShowForm} />
        ) : (
          <Button className="button-blue btn-lawyer" onClick={handleClick}>
            Заполнить анкету
          </Button>
        )}
      </Container>
